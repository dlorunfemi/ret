@extends('layouts.app', ['title' => 'Deposit - Retrixnet'])
        ...
        <div class="container">
            <div class="col-lg-12 mx-auto">
                <div class="row">
                            ...
                            <div class="card-body p-0">
                                <div class="list-group">
                                    <a href="{{ route('assets') }}" class="list-group-item"><img
                                            ...
                                            alt="Assets"> Assets</a>
                                    <a href="{{ route('deposit') }}" class="list-group-item active"><img
                    ...
                    <div class="col-lg-9">
                        <h4 class="fw-bold"><img src="{{ asset('img/deposit.png') }}" width="50" height="50"
                                alt=""> Deposit</h4>
                        <div class="card border-0">
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-lg-5">
                                        ...
                                        <h6 class="fw-bold mt-4 ">Wallets</h6>
                                        <div id="walletsContainer" class="d-flex flex-column gap-3"></div>
                                        <div class="loader" id="walletLoader" style="display:none;">
                                            <span></span><span></span><span></span>
                                        </div>
                                        <div class="mt-4">
                                            <small class="text-muted">Click the button below to submit</small>
                                            <div class="wallet-input-container">
                                                <button class="btn btn_blue w-100 mt-3" id="submitDeposit">
