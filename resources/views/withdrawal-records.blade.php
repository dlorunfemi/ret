@extends('layouts.app', ['title' => 'Withdrawal Records - Retrixnet'])
        ...
        <div class="container">
            <div class="col-lg-12 mx-auto">
                <div class="row g-3">
                        ...
                        <div class="card border-0">
                            <div class="card-body p-0">
                                <div class="list-group">
                                    ...
                                    <a href="{{ route('withdrawal.records') }}" class="list-group-item active"><img
                    ...
                    <div class="col-lg-9">
                        <h4 class="fw-bold"><img src="{{ asset('img/withdraw-record.png') }}" width="50" height="50"
                                alt=""> Withdrawal Records</h4>
                        <div class="card border-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-7">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="table-responsive">
                                                <small class="text-muted">All Withdrawals</small>
                                                <table class="table align-middle">
                                                    ...
                                                    <tbody id="withdrawalsBody">
                                                        <tr id="tx-empty">
                                                            <td colspan="5" class="text-muted">No withdrawals yet.</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
...
@push('scripts')
    <script>
        async function hydrateWithdrawals() {
            ...
            tbody.innerHTML = '';
            (data.data || []).filter(t => t.type === 'withdrawal').forEach(t => {
            ...
            if (!tbody.children.length) {
                const tr = document.createElement('tr');
                tr.innerHTML = '<td colspan="5" class="text-muted">No withdrawals yet.</td>';
                tbody.appendChild(tr);
            }
        }
        document.addEventListener('DOMContentLoaded', hydrateWithdrawals);
    </script>
@endpush
